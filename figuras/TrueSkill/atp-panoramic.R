...
pdf(paste0(nombre,".pdf"), width = 9, height = 4  )
setwd(this.dir)
###############################
...
legend(as.numeric(as.Date("1969-06-01", origin=origin, format = "%Y-%m-%d")),2.2, pch=19, col=rev(c(djokovic, nadal, federer, sampras,aggasi, edberg, lendl,mcenroe, borg,connors)), legend = rev(c("Djokovic", "Nadal", "Federer","Sampras", "Aggasi", "Edberg", "Lendl", "McEnroe", "Borg", "Connors")), bty = "n",cex = 1.25, ncol=5)
