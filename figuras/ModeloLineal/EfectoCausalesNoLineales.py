...
#
import ModeloLinealFull as lm # https://github.com/glandfried/bayesian-linear-model
from ModeloLinealFull import BayesianLinearModel # https://github.com/glandfried/bayesian-linear-model
import random
import numpy as np
